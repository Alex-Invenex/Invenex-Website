...
- [ ] Task 1: Create Careers Page (AC: 1)
  - [ ] Create `src/app/careers/page.tsx`
  - [ ] Add page metadata
  - [ ] Build hero section
  - [ ] Build culture section
  - [ ] Build benefits grid
  - [ ] Build tech stack showcase
...
- [ ] Hero displays with CTA
- [ ] Culture section shows content
- [ ] Benefits grid displays 4 items
- [ ] Tech stack badges show
- [ ] Open positions anchor works
