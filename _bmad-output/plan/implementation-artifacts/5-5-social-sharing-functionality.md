...
- [ ] Task 1: Create Share Buttons Component (AC: 1, 2)
  - [ ] Create `src/components/ui/share-buttons.tsx`
  - [ ] Twitter, LinkedIn, Facebook, Copy buttons
  - [ ] Share URL generation

- [ ] Task 2: Create Toast Component (AC: 3)
  - [ ] Create `src/components/ui/toast.tsx`
  - [ ] Show on successful copy

- [ ] Task 3: Add to Relevant Pages
  - [ ] Case study pages
  - [ ] Service pages
  - [ ] Blog posts (future)
...
- [ ] All share buttons render
- [ ] Twitter opens with correct text and URL
- [ ] LinkedIn opens with correct URL
- [ ] Facebook opens with correct URL
