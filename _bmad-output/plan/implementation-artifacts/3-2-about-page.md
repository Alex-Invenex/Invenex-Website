...
- [ ] Task 1: Create About Page Route (AC: 1)
  - [ ] Create `src/app/about/page.tsx`
  - [ ] Add page metadata

- [ ] Task 2: Build About Hero Section
  - [ ] Create hero with tagline
  - [ ] Add animated background

- [ ] Task 3: Build Company Story Section
  - [ ] Create narrative content
  - [ ] Optional timeline component

- [ ] Task 4: Build Mission & Values Section
  - [ ] Display mission statement
  - [ ] List core values with icons

- [ ] Task 5: Build Team Grid (AC: 2)
  - [ ] Create `src/components/sections/team-grid.tsx`
  - [ ] TeamMemberCard with hover effects
  - [ ] LinkedIn link reveal
