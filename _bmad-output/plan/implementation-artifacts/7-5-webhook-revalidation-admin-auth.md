...
- [ ] Task 1: Create Revalidation API Route (AC: 1, 2)
  - [ ] Create `src/app/api/sanity/revalidate/route.ts`
  - [ ] Implement signature validation
  - [ ] Implement tag-based revalidation

- [ ] Task 2: Configure Sanity Webhook (AC: 1)
  - [ ] Add webhook in Sanity dashboard
  - [ ] Configure secret and URL
  - [ ] Test webhook delivery

- [ ] Task 3: Setup NextAuth.js (AC: 3)
  - [ ] Install next-auth
...
- [ ] Webhook receives events from Sanity
- [ ] Signature validation works
- [ ] revalidateTag triggers rebuild
- [ ] Pages update after content change
- [ ] Login page works
- [ ] Studio route is protected
